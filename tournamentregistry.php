...
<body>
	...
	<table class="tinfo">
		...
		<tr>
			...
			<td>City:
				<?php echo "$result[6]"; ?>, State:
				<?php echo "$result[7]"; ?>, Zip:
				<?php echo "$result[8]"; ?>
			</td>
	...
	<button type="button" class="reg" onclick=<?php echo"location.href='registration.php?tid=$tid'";?>>Register</button>
